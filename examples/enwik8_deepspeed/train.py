# -*- coding: utf-8 -*-
"""audio_preprocessing_blocksparse_new_ver2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rVOUtKPoR9Yg4OoIGU7D7HwCzkHs2aHC
...
# rand_start = t.randint(0, 9749 - 1, (1,))
# rand_start
...
def eval(model, opt,metrics, train_loader, hps):
    ...
    with t.no_grad():
      for i, x in enumerate(train_loader):
          ...
          save_to_wav('/content/drive/My Drive/VQVAE-trans/output-VQVAE',x_out,44100,i)
...
for epoch in range(NUM_BATCHES):
    ...
    for i in tqdm(train_loader):
        ...
        rescale = lambda z_shape: (z_shape[0]*44100//vqvae.z_shapes[0][0],)
